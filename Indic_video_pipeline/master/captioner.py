...
BUCKET_PROMPT_FILES = {
    ...
    # New named taxonomy (see common/buckets.py) -> caption_<name>.txt
    "portrait_closeup":          "caption_portrait_closeup.txt",
    "two_shot":                  "caption_two_shot.txt",
    "group":                     "caption_group.txt",
    "crowd":                     "caption_crowd.txt",
    "song_dance":                "caption_song_dance.txt",
    "action_fight":              "caption_action_fight.txt",
    "interior_domestic":         "caption_interior_domestic.txt",
    "street_urban":              "caption_street_urban.txt",
    "rural_village":             "caption_rural_village.txt",
    "religious_festival_ritual": "caption_religious_festival_ritual.txt",
    "landscape_nature":          "caption_landscape_nature.txt",
    "architecture_monument":     "caption_architecture_monument.txt",
    "object_food_artifact":      "caption_object_food_artifact.txt",
    "text_poster_graphic":       "caption_text_poster_graphic.txt",
    "intimate_suggestive":       "caption_intimate_suggestive.txt",
}
